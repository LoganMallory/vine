double benchmark_greater_than_constant() {
  Vine<int> vec1(SIZE);
...
double benchmark_greater_than_vine() {
  Vine<int> vec1(SIZE);
  Vine<int> vec2(SIZE);
...
double benchmark_greater_than_equal_to_constant() {
  Vine<int> vec1(SIZE);
...
double benchmark_greater_than_equal_to_vine() {
  Vine<int> vec1(SIZE);
  Vine<int> vec2(SIZE);
